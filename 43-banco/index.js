...
App.createUser('larissa@email.com', 'Larissa Rosa')
...
App.takeLoan('larissa@email.com', 2000, 24)
...
console.log(App.findUser('larissa@email.com').account)
console.log(App.findUser('larissa@email.com').account.loans[0].installments)